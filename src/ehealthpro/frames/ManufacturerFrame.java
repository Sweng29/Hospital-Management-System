...
public class ManufacturerFrame extends javax.swing.JFrame {
    ...
    public ManufacturerFrame() {
        ...
        checkPermissions();
        resetAddButton();
        this.setTitle("Manufacturer || E-Health Pro");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 120, -1, 29));

        manufacturerTextfield.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jPanel1.add(manufacturerTextfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 120, 300, 29));

        manufacturerTable.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 1220, 310));

        jLabel3.setFont(new java.awt.Font("Century Gothic", 0, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(153, 0, 0));
        jLabel3.setText("Manufacturer Record : ");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, -1, 29));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1250, 530));
        ...
        jPanel2.add(addButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 30, 220, -1));
        ...
        jPanel2.add(updateButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 30, 230, -1));
        ...
        jPanel2.add(deleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 30, 240, 50));
        ...
        jPanel2.add(clearFieldsButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 30, 240, 50));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 530, 1250, 110));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        if (manufacturerTextfield.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Please insert manufacturer name to add record.");
        } else {
            String manufacturerName = manufacturerTextfield.getText();
            currentDate = new Timestamp(System.currentTimeMillis());
            ManufacturerModel manufacturerModel = new ManufacturerModel();
            manufacturerModel.setName(manufacturerName);
            manufacturerModel.setCreatedBy(1);
            manufacturerModel.setCreatedDate(currentDate);
            manufacturerModel.setModifiedBy(1);
            manufacturerModel.setModifiedDate(currentDate);
            ManufacturerDAOImpl manufacturerDAOImpl = new ManufacturerDAOImpl();
            int result = manufacturerDAOImpl.addManufacturer(manufacturerModel);
            if (result > 0) {
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
            ...
            manufacturerModel.setCreatedBy(1);
            manufacturerModel.setCreatedDate(currentDate);
            manufacturerModel.setModifiedBy(2);
            manufacturerModel.setModifiedDate(currentDate);
            manufacturerModel.setManufacturerId(manufacturerId);
            ManufacturerDAOImpl manufacturerDAOImpl = new ManufacturerDAOImpl();
            int result = manufacturerDAOImpl.updateManufacturer(manufacturerModel);
            if (result > 0) {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
            ...
            manufacturerModel.setManufacturerId(manufacturerId);
            ManufacturerDAOImpl manufacturerDAOImpl = new ManufacturerDAOImpl();
            int result = manufacturerDAOImpl.deleteManufacturerById(manufacturerModel);
            if (result > 0) {
    ...
    private void manufacturerTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_manufacturerTableMouseClicked
        manufacturerId = (Integer) manufacturerTable.getValueAt(manufacturerTable.getSelectedRow(), 0);
        ManufacturerModel manufacturerModel = new ManufacturerDAOImpl().getManufacturerById(manufacturerId);
        manufacturerTextfield.setText(manufacturerModel.getName());
        setButtons();
    ...
    private void fillManufacturerTable() {
        ...
        manufacturerTable.setModel(DbUtils.resultSetToTableModel(resultset));
    }
    ...
    private void checkPermissions() {
        ...
        try {
            while(assignedPermissions.next())
            {
                ...
                if(permissionModel.getPermission().equals("ADD_MANUFACTURER"))
                {
                    addButton.setVisible(true);
                }
                if(permissionModel.getPermission().equals("DELETE_MANUFACTURER"))
                {
                    deleteButton.setVisible(true);
                }
                if(permissionModel.getPermission().equals("UPDATE_MANUFACTURER"))
                {
